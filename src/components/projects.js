...
class Projects extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div className="bg-primary mt-3 page-headings">Some Projects</div>
                ...
                <div className="row no-gutters">
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      <h5 className="card-title text-primary display-8">
                        <span className="font-weight-bolder text-dark display-8">
                          Project
                        </span>
                        :
                        <a
                      ...
                      <div className="text-primary display-8">
                        <span className="font-weight-bolder text-dark display-8">
                          Name
                        </span>
                        : {data.name}
